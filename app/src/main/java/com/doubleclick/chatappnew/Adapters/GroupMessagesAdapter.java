...
import com.doubleclick.chatappnew.databinding.DeleteDialogBinding;
import com.doubleclick.chatappnew.databinding.ItemReceiveGroupBinding;
import com.doubleclick.chatappnew.databinding.ItemSentGroupBinding;
...
public class GroupMessagesAdapter extends RecyclerView.Adapter {
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        ...
        ReactionPopup popup = new ReactionPopup(context, config, (ReactionPosition) -> {
            if (holder.getClass() == SentViewHolder.class) {
                SentViewHolder viewHolder = (SentViewHolder) holder;
                if (ReactionPosition == 0 || ReactionPosition == 1 || ReactionPosition == 2 || ReactionPosition == 3 || ReactionPosition == 4 || ReactionPosition == 5) {

                    viewHolder.binding.feeling.setImageResource(reactions[ReactionPosition]);
                }
